...
$select = "SELECT *,time_format(startTime, '%h:%i%p') as newStart, time_format(endTime, '%h:%i%p') as newEnd from event";
   ...
   <center>
    <table class="table table-bordered table-striped table-hover table-responsive">
      ...
      <?php while($row = mysqli_fetch_assoc($rSelect)){
       ...
       echo "<td><a href='updateEvent.php?id=" . $row["id"] . "' title='Edit Event'><span class='glyphicon glyphicon-pencil'></span></a></td>";
       echo "<td><a href='addAttendees.php?id=" . $row["id"] . "' title='Add Attendees'><span class='glyphicon glyphicon-plus'></span></a></td>";
       echo "<td><a href='viewAttendees.php?id=" . $row["id"] . "' title='View Attendees'><i class='material-icons'>people</i></a></td>";
       echo "<td><a href='deleteEvent.php?id=" . $row["id"] . "' title='Delete Event' onClick=\"return confirm('Are you sure you want to delete this event?')\"><span class='glyphicon glyphicon-trash'></span></a></td>";
       echo "</tr>";
