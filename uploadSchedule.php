...
<html>
<head>
 <title>Batch Upload for Room/Class Schedule</title>
 <meta charset="ultf-8">
    ...
    <div class="center" style="margin-left: 17px;">
      ...
      <form action="upload_roomSchedule.php" enctype="multipart/form-data" method="post" role="form">
        <div class="form-group">
          <center>
            <label class="quicksandHeading" for="exampleInputFile">Upload CSV for Room Schedule</label>
            <input class="quicksandHeading"  type="file" name="file[]" size="100000" multiple required /> 
            <p class="help-block quicksandHeading">Only CSV File Format.</p>
