...
<body>
  ...
  <div class="container">
    <center>
      ...
      <br/><br/><br/><br/>
      <p style="font-size: 18px; font-family: Quicksand;">Make up class has been updated.</p>
      <br/><br/><br/><br/><br/><br/>
      <button type="button" class="CancelButton" onclick="window.location.href='makeUpClass.php'">Back</button>
    </center>
